...
public class PostfixExpressionCalculatorTest {
    ...
    @Test
    public void should_return_right_value_of_the_postfix_expression() throws StackEmptyException {
        ...
        expression = "2 1 + 3 4 * +";
        calculator = new PostfixExpressionCalculator(expression);
        Assert.assertTrue(calculator.calculator() == 15);
    }
